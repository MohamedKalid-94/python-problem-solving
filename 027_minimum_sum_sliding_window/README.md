# Problem 27 — Minimum Sum of Consecutive Elements

## Problem
Find the minimum sum of `window_size` consecutive numbers in a list.
...
For a minimum problem, compare each new window sum with `min_sum`.